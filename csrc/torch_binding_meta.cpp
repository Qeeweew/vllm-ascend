...
std::tuple<at::Tensor> compressor_epilogue_meta(const at::Tensor &mm_kv, const at::Tensor &mm_score,
...
TORCH_LIBRARY_IMPL_EXPAND(CONCAT(_C, _ascend), Meta, ops) {
    ...
    ops.impl("compressor_epilogue", &vllm_ascend::meta::compressor_epilogue_meta);
