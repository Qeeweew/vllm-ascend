...
template <typename COMP>
class CompressorEpilogueSliceIterator {
public:
    __aicore__ inline CompressorEpilogueSliceIterator(CompressorEpilogueTools<COMP> &tools) : tools_(tools)
    {
    }
...
template <typename COMP>
__aicore__ inline void CompressorEpilogueSliceIterator<COMP>::Reset(uint32_t bIdx, uint32_t sIdx)
{
...
template <typename COMP>
__aicore__ inline void CompressorEpilogueSliceIterator<COMP>::SetMaxBatchSize(uint32_t batch_size)
{
    this->batch_size_ = batch_size;
}

template <typename COMP>
__aicore__ inline void CompressorEpilogueSliceIterator<COMP>::SetMaxDealSeqCnt(uint32_t maxDealSeqCnt)
{
    this->maxDealSeqCnt_ = maxDealSeqCnt;
}

template <typename COMP>
__aicore__ inline bool CompressorEpilogueSliceIterator<COMP>::IsEnd()
{
    return (sliceInfo_.bIdx >= batch_size_) || (maxDealSeqCnt_ == 0);
}

template <typename COMP>
__aicore__ inline void CompressorEpilogueSliceIterator<COMP>::IteratorSlice()
{
...
template <typename COMP>
__aicore__ inline SliceInfo &CompressorEpilogueSliceIterator<COMP>::GetSliceByCmp()
{
...
template <typename COMP>
__aicore__ inline SliceInfo &CompressorEpilogueSliceIterator<COMP>::GetSlice()
{
    uint32_t cmpRatio = tools_.toolParams_.cmpRatio;
    if (isFirst_) {
        sliceInfo_.bSeqUsed = tools_.GetSeqUsed(sliceInfo_.bIdx);
...
template <typename COMP>
class CompressorEpilogueSplitCoreSliceIterator {
public:
    __aicore__ inline CompressorEpilogueSplitCoreSliceIterator(CompressorEpilogueTools<COMP> &tools) : tools_(tools)
    {
    }
...
template <typename COMP>
__aicore__ inline void CompressorEpilogueSplitCoreSliceIterator<COMP>::Reset(uint32_t bIdx, uint32_t sIdx)
{
    sliceInfo_.bIdx = bIdx;
    sliceInfo_.sIdx = sIdx;
    isFirst_ = true;
...
template <typename COMP>
__aicore__ inline void CompressorEpilogueSplitCoreSliceIterator<COMP>::SetMaxBatchSize(uint32_t batch_size)
{
    this->batch_size_ = batch_size;
...
template <typename COMP>
__aicore__ inline void CompressorEpilogueSplitCoreSliceIterator<COMP>::SetMaxDealSeqCnt(uint32_t maxDealSeqCnt)
{
    this->maxDealSeqCnt_ = maxDealSeqCnt;
}

template <typename COMP>
__aicore__ inline bool CompressorEpilogueSplitCoreSliceIterator<COMP>::IsEnd()
{
    return (sliceInfo_.bIdx >= batch_size_) || (maxDealSeqCnt_ == 0);
}

template <typename COMP>
__aicore__ inline uint32_t CompressorEpilogueSplitCoreSliceIterator<COMP>::GetBIdx()
{
    return sliceInfo_.bIdx;
}

template <typename COMP>
__aicore__ inline void CompressorEpilogueSplitCoreSliceIterator<COMP>::IteratorSlice()
{
    bool isUpdateBatchInfo = false;
...
template <typename COMP>
__aicore__ inline SplitCoreSliceInfo &CompressorEpilogueSplitCoreSliceIterator<COMP>::GetLeftNextCmpSeqCnt()
{
    uint32_t cmpRatio = tools_.toolParams_.cmpRatio;
    if (isFirst_) {
        // 左边 T轴首次减去T轴最后一块
...
template <typename COMP>
__aicore__ inline SplitCoreSliceInfo &CompressorEpilogueSplitCoreSliceIterator<COMP>::GetRightNextCmpSeqCnt()
{
    uint32_t cmpRatio = tools_.toolParams_.cmpRatio;
    if (isFirst_) {
        sliceInfo_.bSeqUsed = tools_.GetSeqUsed(sliceInfo_.bIdx);
