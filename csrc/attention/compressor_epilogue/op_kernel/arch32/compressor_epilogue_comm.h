 ...
 * \brief compressor_epilogue 公共定义：常量、对齐工具、DataCopy 帮助函数
 *
 * 算子语义（与 attention/compressor 融合算子的 vec 部分严格一致，去掉 GEMM）：
 ...
 * 详细设计见 experimental/attention/compressor-epilogue/DESIGN.md
 */
...
// rotary_mode 属性值（对齐 vllm-ascend）
...
#endif // COMPRESSOR_EPILOGUE_COMM_H
