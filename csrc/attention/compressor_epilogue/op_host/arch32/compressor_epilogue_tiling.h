...
/*!
 * \file compressor_epilogue_tiling.h
 * \brief
 */

#ifndef COMPRESSOR_EPILOGUE_TILING_H
#define COMPRESSOR_EPILOGUE_TILING_H
...
#include "../../op_kernel/arch32/compressor_epilogue_template_tiling_key.h"
#include "../../op_kernel/arch32/compressor_epilogue_tiling_data.h"
...
constexpr uint32_t COMPRESSOR_EPILOGUE_DIM_NUM_1 = 1;
constexpr uint32_t COMPRESSOR_EPILOGUE_DIM_NUM_2 = 2;
constexpr uint32_t COMPRESSOR_EPILOGUE_DIM_NUM_3 = 3;
constexpr uint32_t COMPRESSOR_EPILOGUE_DIM_NUM_4 = 4;
constexpr uint32_t COMPRESSOR_EPILOGUE_DIM_INDEX_0 = 0;
constexpr uint32_t COMPRESSOR_EPILOGUE_DIM_INDEX_1 = 1;
constexpr uint32_t COMPRESSOR_EPILOGUE_DIM_INDEX_2 = 2;
constexpr uint32_t COMPRESSOR_EPILOGUE_DIM_INDEX_3 = 3;
...
static const std::string MM_KV_NAME = "mm_kv";
static const std::string MM_SCORE_NAME = "mm_score";
...
const std::map<std::string, std::vector<ge::DataType>> DTYPE_SUPPORT_MAP = {
    {MM_KV_NAME,                  {ge::DT_BF16, ge::DT_FLOAT16}},
    {MM_SCORE_NAME,                {ge::DT_BF16, ge::DT_FLOAT16}},
...
const std::map<std::string, std::vector<uint32_t>> DIM_NUM_MAP = {
    {MM_KV_NAME,                  {COMPRESSOR_EPILOGUE_DIM_NUM_2, COMPRESSOR_EPILOGUE_DIM_NUM_3}},
    {MM_SCORE_NAME,                {COMPRESSOR_EPILOGUE_DIM_NUM_2, COMPRESSOR_EPILOGUE_DIM_NUM_3}},
    {STATE_CACHE_NAME,        {COMPRESSOR_EPILOGUE_DIM_NUM_3}},
    {APE_NAME,                {COMPRESSOR_EPILOGUE_DIM_NUM_2}},
    {NORM_WEIGHT_NAME,        {COMPRESSOR_EPILOGUE_DIM_NUM_1}},
    {ROPE_SIN_NAME,           {COMPRESSOR_EPILOGUE_DIM_NUM_2, COMPRESSOR_EPILOGUE_DIM_NUM_3}},
    {ROPE_COS_NAME,           {COMPRESSOR_EPILOGUE_DIM_NUM_2, COMPRESSOR_EPILOGUE_DIM_NUM_3}},
    {STATE_BLOCK_TABLE_NAME,  {COMPRESSOR_EPILOGUE_DIM_NUM_2, COMPRESSOR_EPILOGUE_DIM_NUM_1}},
    {CU_SEQLENS_NAME,         {COMPRESSOR_EPILOGUE_DIM_NUM_1}},
    {SEQUSED_NAME,            {COMPRESSOR_EPILOGUE_DIM_NUM_1}},
    {START_POS_NAME,          {COMPRESSOR_EPILOGUE_DIM_NUM_1}},
    {CMP_KV_NAME,             {COMPRESSOR_EPILOGUE_DIM_NUM_2, COMPRESSOR_EPILOGUE_DIM_NUM_3}}
};

static const std::map<std::string, uint32_t> LAYOUT_DIM_MAP = {
    {"BSH", COMPRESSOR_EPILOGUE_DIM_NUM_3},
    {"TH", COMPRESSOR_EPILOGUE_DIM_NUM_2},
};
...
struct CompressorEpilogueCompileInfo {
    int64_t core_num;
};
...
struct CompressorEpilogueBaseShapeInfo {
    uint32_t bSize = 0; // B
    uint32_t sSize = 0; // S
...
struct CompressorEpilogueContext {
    const char *opName;
    const char *opType;
...
class CompressorEpilogueTiling {
public:
    explicit CompressorEpilogueTiling(CompressorEpilogueContext *context) : context_(context) {}
    ~CompressorEpilogueTiling() = default;

    static ge::graphStatus ConvertContext(gert::TilingContext &context, CompressorEpilogueContext &compressor_epilogueContext);
    ge::graphStatus RunBigKernelTiling(CompressorEpilogueTilingData* tilingData);

private:
    static void ConvertRequiredParams(gert::TilingContext &context, CompressorEpilogueContext &compressor_epilogueContext);

    static void ConvertOptionalParams(gert::TilingContext &context, CompressorEpilogueContext &compressor_epilogueContext);
    ...
    ge::graphStatus CheckSingleParaMmKv() const;
    ge::graphStatus CheckSingleParaMmScore() const;
    ...
    ge::graphStatus CheckDtypeConsistencyMm(const gert::CompileTimeTensorDesc *desc, const std::string &name) const;
    ...
    CompressorEpilogueBaseShapeInfo baseShapeInfo_;
    CompressorEpilogueContext *context_ = nullptr;
    CompressorEpilogueBaseParams *baseParams_ = nullptr;
    CompressorEpiloguePageAttentionParams *pageAttentionParams_ = nullptr;
    CompressorEpilogueInnerSplitParams *innerSplitParams_ = nullptr;
    CompressorEpilogueWorkspaceParams *workspaceParams_ = nullptr;
};
