...
namespace ops {
class CompressorEpilogue : public OpDef {
public:
    ...
    explicit CompressorEpilogue(const char *name) : OpDef(name)
    {
        this->Input("mm_kv")
            .ParamType(REQUIRED)
...
OP_ADD(CompressorEpilogue, optiling::CompressorEpilogueCompileInfo);
} // namespace ops
