...
#ifndef V41_INDEX_CACHE_STORE_TILING_H
#define V41_INDEX_CACHE_STORE_TILING_H
#include "register/tilingdata_base.h"
namespace optiling {
BEGIN_TILING_DATA_DEF(V41IndexCacheStoreTilingData)
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(V41IndexCacheStore, V41IndexCacheStoreTilingData)
}  // namespace optiling
#endif
